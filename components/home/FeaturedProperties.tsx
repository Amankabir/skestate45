...
import { Heart, Share2, GitCompareArrows, BedDouble, Bath, Maximize, Calendar } from "lucide-react";
import { motion, AnimatePresence } from "framer-motion";
import { PROPERTIES } from "@/constants/content";
import { SectionHeading } from "@/components/ui/SectionHeading";
import { FadeIn, ScaleReveal } from "@/animations/Reveal";
      ...
      >
        ...
        <div className="p-5 md:p-6">
          <div className="flex items-start justify-between gap-3">
            <div>
              ...
              <h3 className="font-display mt-1 text-xl text-navy md:text-2xl">
                <Link href={property.href} className="transition-colors hover:text-gold">
                  {property.title}
                </Link>
              </h3>
          ...
          <div className="mt-5 flex flex-wrap gap-4 border-t border-soft-gray/80 pt-4 text-sm text-navy-muted">
            ...
            <span className="inline-flex items-center gap-1.5">
              <Maximize className="h-4 w-4 text-gold" /> {property.area.toLocaleString()} sq.ft
            </span>
          </div>
      ...
      <div className="container-luxury">
        <div className="flex flex-col items-start justify-between gap-6 md:flex-row md:items-end">
          <SectionHeading
            ...
            title="Homes of uncommon character"
            description="A living gallery of residences chosen for light, craft, and enduring desirability."
          />
          <FadeIn delay={0.2}>
            <MagneticButton as="a" href="/properties" className="btn-primary rounded-full">
              View All Residences
            </MagneticButton>
          </FadeIn>
        </div>
