    ...
    >
      <div className="container-luxury">
        <SectionHeading
          ...
          title="Words from those who live here"
          description="Quiet confidence from families, founders, and collectors who chose SK Estate."
          align="center"
          className="mx-auto"
        />
            ...
            {TESTIMONIALS.map((t) => (
              <SwiperSlide key={t.id}>
                <figure className="glass relative rounded-3xl px-8 py-10 md:px-14 md:py-14">
                  ...
                  <blockquote className="font-accent text-2xl leading-snug text-navy md:text-3xl md:leading-snug">
                    &ldquo;{t.quote}&rdquo;
                  </blockquote>
