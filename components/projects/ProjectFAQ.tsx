...
export function ProjectFAQ({ projectName, faqs }: ProjectFAQProps) {
      ...
      <div className="container-luxury">
        <div className="grid gap-12 lg:grid-cols-[0.85fr_1.15fr] lg:gap-20">
          <SectionHeading
            ...
            description="Pricing, possession, RERA, and booking — answered clearly."
          />
                ...
                <FadeIn key={faq.id} delay={i * 0.05}>
                  ...
                  >
                    <button
                      ...
                      aria-controls={`project-faq-${faq.id}`}
                      id={`project-faq-btn-${faq.id}`}
                    ...
                    <AnimatePresence initial={false}>
                      {isOpen && (
                        <motion.div
                          id={`project-faq-${faq.id}`}
                          role="region"
                          aria-labelledby={`project-faq-btn-${faq.id}`}
