...
export function ProjectReviews({ testimonials }: ProjectReviewsProps) {
  return (
    <section
    ...
    >
      <div className="container-luxury">
        <SectionHeading
          ...
          title="Voices from early allottees"
          description="Honest experiences from buyers who chose this address with SK Estate."
          align="center"
          className="mx-auto"
        />
            ...
            {testimonials.map((t) => (
              <SwiperSlide key={t.id}>
                <figure className="glass relative rounded-3xl px-8 py-10 md:px-14 md:py-14">
                  <Quote
                    className="absolute right-8 top-8 h-12 w-12 text-gold/25"
                    aria-hidden
                  />
                  <div
